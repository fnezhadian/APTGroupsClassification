...
def apply_classifiers(vectors, target):
    for test_size in test_sizes:
        ...
        # classifier = RandomForestClassifier(max_features='sqrt', n_estimators=1000, criterion=criterion)
        classifier = RandomForestClassifier(max_features='sqrt', n_estimators=1000, criterion='gini')
...
def main():
    ...
    # get_param_tuning(vectors, target)  # result: best estimator -> RandomForestClassifier(max_features='sqrt', n_estimators=1000)
    apply_classifiers(vectors, target)  # result: best criterion -> gini, test_size: 0.2
