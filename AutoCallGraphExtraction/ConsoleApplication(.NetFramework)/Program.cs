...
namespace AutoCallGraphExtraction
{
    class Program
    {
        ...
        const string ScriptPath = @"D:\Material\Script\GenerateDOTGraph.py";
        const string MalwareSamplesPath = @"D:\Material\APTMalware-master\samples";
        const string OutputPath = @"D:\Material\DOT";
        ...
        /// This method gets and renames the directories
        /// </summary>
